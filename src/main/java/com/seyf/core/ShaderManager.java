...
public class ShaderManager {
    ...
    public void createPointLightsListUniform(String uniformName, int size) throws Exception{
    ...
    public void createSpotLightsListUniform(String uniformName, int size) throws Exception{
        for(int i=0; i<size; i++){
    ...
    public void setUniform(String unifromName, int value){
        GL20.glUniform1i(uniforms.get(unifromName),value);
    }
    public void setUniform(String unifromName, float value){
        GL20.glUniform1f(uniforms.get(unifromName),value);
    }
